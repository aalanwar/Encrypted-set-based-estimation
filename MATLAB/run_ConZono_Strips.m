...
while (t_last - t_start) < t_stop
    ...
    x_conzono = intersectConZonoStrip1(x_conzono_init,hl,Rl,yl);  
    ...
    %x_conzono=reduce(x_conzono,'combastel',5,2);
...
%dlmwrite('zvector_zcontstrips.csv',z2vector,'delimiter', ',', 'precision', 9)
